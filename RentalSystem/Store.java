...
import RentalSystem.Product.Vehicle;
import RentalSystem.Product.VehicleType;
...
public class Store {
    ...
    List<Reservation> reservations = new ArrayList<>();// Kitne Reservation aa rakhe h store pr
